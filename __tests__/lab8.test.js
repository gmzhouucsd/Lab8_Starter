...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const clickedButton = await productButton.click();
    const buttonText = await clickedButton.getProperty('innerText');
    let correctText = 'Remove from Cart';
    expect(buttonText['_remoteObject'].value).toBe(correctText);
  }, 2500);
